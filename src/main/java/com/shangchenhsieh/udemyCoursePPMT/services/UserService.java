...
import com.shangchenhsieh.udemyCoursePPMT.exceptions.UsernameAlreadyExistedException;
...
public class UserService {
    ...
    public User saveUser (User newUser){
        ...
        try{
            ...
            throw new UsernameAlreadyExistedException("Username '"+newUser.getUsername()+"' already exists");
        }
